...
import { Users, Settings, Shield, FileText, Activity, Database, UserCircle, Code, Share2 } from "lucide-react";
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/settings/profile" className="p-6 border rounded-lg hover:bg-accent transition-colors flex flex-col items-center text-center gap-4 group">
          <div className="p-3 bg-primary/10 rounded-full group-hover:bg-primary/20 transition-colors">
            <UserCircle className="h-8 w-8 text-primary" />
          </div>
          <div>
            <h3 className="font-semibold text-lg">Můj profil</h3>
            <p className="text-sm text-muted-foreground mt-1">Osobní údaje, avatar a smazání účtu</p>
          </div>
        </Link>
        ...
        <Link href="/settings/integrations" className="p-6 border rounded-lg hover:bg-accent transition-colors flex flex-col items-center text-center gap-4 group">
          <div className="p-3 bg-primary/10 rounded-full group-hover:bg-primary/20 transition-colors">
            <Share2 className="h-8 w-8 text-primary" />
          </div>
          <div>
            <h3 className="font-semibold text-lg">Integrace</h3>
            <p className="text-sm text-muted-foreground mt-1">Google Drive, Kalendář, Webhooky</p>
          </div>
        </Link>
        ...
        <Link href="/settings/developers" className="p-6 border rounded-lg hover:bg-accent transition-colors flex flex-col items-center text-center gap-4 group">
          <div className="p-3 bg-primary/10 rounded-full group-hover:bg-primary/20 transition-colors">
            <Code className="h-8 w-8 text-primary" />
          </div>
          <div>
            <h3 className="font-semibold text-lg">Pro vývojáře</h3>
            <p className="text-sm text-muted-foreground mt-1">API klíče a webhooky</p>
          </div>
        </Link>
      </div>
    </div>
